...
(my $mm, my $clusterFile, my $rmsk_file, my $outDir, my $mapToConsensus_file) = @ARGV; #mm, clusterFile and rmsk_file are mandatory
die "cluster file: $clusterFile doesn't exist\n" unless (-e $clusterFile);
$mm = "GA" unless $mm; 
# $clusterFile = "/home/alu/binknis/Data/FULGL/LTR/results/Tracks/tracks_FULGL_LTR_ERVL_1e-0_5/".$mm."/clusters_FULGL_LTR_ERVL_1e-0_5.tab" unless $clusterFile; 
...
$outDir = $trackDir ."/". "filteredClusts" unless $outDir; 
mkdir $outDir; 
###TEMP***
...
$mapToConsensus_file = $trackDir ."/". "nucListFreqPerPair_".$nuc."_".$fileSuff.".txt" unless $mapToConsensus_file; 
